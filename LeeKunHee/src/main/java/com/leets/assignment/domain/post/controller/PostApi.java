...
public interface PostApi {
    ...
    ApiResponse<PostResponseDTO.PostDetailResDTO> createPost(PostRequestDTO.CreatePostDTO request);
    ...
    ApiResponse<PostResponseDTO.PostDetailResDTO> getPost(@Parameter(description = "게시글 ID") Long postId);
    ...
    ApiResponse<PostResponseDTO.PostDetailResDTO> updatePost(Long postId, PostRequestDTO.UpdatePostDTO request);
    ...
    ApiResponse<Void> deletePost(Long postId, Long userId);
    ...
    ApiResponse<Void> hidePost(Long postId, Long userId);
}